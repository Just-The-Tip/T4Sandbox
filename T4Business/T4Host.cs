...
using System.IO;
using System.Text;
using T4Business.GacWrapper;

namespace T4Business
{
    ...
    //-------------------------------------------------------------------------
    [Serializable]
    public class T4Host : ITextTemplatingEngineHost, ITextTemplatingSessionHost
    {
        ITextTemplatingSession _session = new TextTemplatingSession();
        ...
        public string ResolveAssemblyReference(string assemblyReference)
        {
            ...
            // check same folder
            candidate = @".\" + assemblyReference + ".dll";
            if(File.Exists(candidate))
            {
                return candidate;
            }
        ...
        public string ResolveParameterValue(string directiveId, string processorName, string parameterName)
        {
            if (directiveId == null)
            {
                throw new ArgumentNullException("directiveId", "the directiveId cannot be null");
            }
            if (processorName == null)
            {
                throw new ArgumentNullException("processorName", "the processorName cannot be null");
            }
            if (parameterName == null)
            {
                throw new ArgumentNullException("parameterName", "the parameterName cannot be null");
            }
